...
class Attention(Layer):
    ...
    def __init__(self, hidden, init='glorot_uniform', activation='linear',
    ...
    def build(self, input_shape):
        ...
        self.W0 = self.add_weight(name='{}_W1'.format(self.name),
                                  shape=(input_dim, self.hidden),
                                  initializer='glorot_uniform',
                                  trainable=True)  # Keras 2 API
    ...
    def call(self, x, mask=None):
        ...
        # Output the attention maps but do not pass it to
        # the next layer by DIY flatten layer
